...
def test_precache_counts_method_direct_call():
    ...
    fc_all = FastCount.objects.get(content_type=model_ct, manager_name=manager_name_expected, queryset_hash=key_all)
    ...
    fc_true = FastCount.objects.get(content_type=model_ct, manager_name=manager_name_expected, queryset_hash=key_true)
